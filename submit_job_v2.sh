...
srun -u shifter --image=amahesh19/modulus-makani:0.1.0-torch_patch-23.11-multicheckpoint --module=gpu,nccl-2.18 bash -c "source set_74ch_vars.sh; pip list; python -I -m earth2mip.inference_ensemble configs/test_n1.json"
echo "Completed run"